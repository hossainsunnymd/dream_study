...
const props = defineProps({
    verifyEmailBannerImage: {
        type: [String, File],
        default: null,
    },
});

const currentImage = props.verifyEmailBannerImage
    ? `/storage/logo/${props.verifyEmailBannerImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : verifyEmailBannerImage ? `/storage/logo/${verifyEmailBannerImage}` : 'placeholder.png'"
