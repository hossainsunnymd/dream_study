...
const currentImage = props.resetPasswordBannerImage
    ? `/storage/logo/${props.resetPasswordBannerImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : resetPasswordBannerImage ? `/storage/logo/${resetPasswordBannerImage}` : 'placeholder.png'"
        class="img-thumbnail border border-dark rounded w-100"
        style="width: 100px; height: 100px; object-fit: cover;"
        alt="Reset Password Banner Image"
      />
    </label>
