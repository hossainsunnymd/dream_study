...
const currentImage = props.carouselImage
    ? `/storage/carousel/${props.carouselImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : carouselImage ? `/storage/carousel/${carouselImage}` : 'placeholder.png'"
